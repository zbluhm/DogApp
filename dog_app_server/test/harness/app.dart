import 'package:dog_app_server/model/user.dart';
import 'package:dog_app_server/dog_app_server.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:dog_app_server/dog_app_server.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for dog_app_server.
///
...
///         }
///
class Harness extends TestHarness<DogAppServerChannel> with TestHarnessAuthMixin<DogAppServerChannel>, TestHarnessORMMixin {
  @override
