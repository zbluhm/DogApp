...
import 'dog_app_server.dart';

/// This type initializes an application.
///
/// Override methods in this class to set up routes and initialize services like
/// database connections. See http://aqueduct.io/docs/http/channel/.
class DogAppServerChannel extends ApplicationChannel implements AuthCodeControllerDelegate {
  ...
  Future prepare() async {
    ...
    final config = DogAppServerConfiguration(options.configurationFilePath);
...
class DogAppServerConfiguration extends Configuration {
  DogAppServerConfiguration(String fileName) : super.fromFile(File(fileName));
